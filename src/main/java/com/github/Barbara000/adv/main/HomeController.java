...
import com.github.Barbara000.adv.logika.Vec;
...
public class HomeController extends GridPane implements Observer, Initializable {
	...
	@Override
         ...
         @FXML public void Napoveda() 
        {
            ...
            webView.getEngine().load(com.github.Barbara000.adv.main.Adventura.class.getResource("/zdroje/napoveda.html").toExternalForm());
	...
	public void update(Observable arg0, Object arg1) 
        {
		uzivatel.setX(hra.getHerniPlan().getAktualniProstor().getPosX());
		uzivatel.setY(hra.getHerniPlan().getAktualniProstor().getPosY());
            
                veciMistnost.clear();
                veciBatoh.clear();
                vychody.clear();
		String sVychody = hra.getHerniPlan().getAktualniProstor().seznamVychoduProPanely();
                ...
                Map<String, Vec> sBatoh = hra.getBatoh().getSeznamVeci();
                for (String x : sBatoh.keySet()) 
                {
                    Vec pomocna = sBatoh.get(x);
                    ImageView obrazek = new ImageView(new Image(com.github.Barbara000.adv.main.Adventura.class.getResourceAsStream("/"+pomocna.getObrazek()), 100, 100, false, false));
